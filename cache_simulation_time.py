...
plt.plot(time_array, dispatcher_small_server_hit_count_ratio, marker='o', color='red', label='dispatcher')
plt.plot(time_array, big_server_hit_count_ratio, marker='o', color='black', label='big cache')
plt.xlabel("time")
...
plt.figure(figsize=(15, 8))
plt.plot(time_array, dispatcher_small_server_hit_byte_ratio, marker='o', color='red', label='dispatcher')
plt.plot(time_array, big_server_hit_byte_ratio, marker='o', color='black', label='big cache')
plt.xlabel("time")
